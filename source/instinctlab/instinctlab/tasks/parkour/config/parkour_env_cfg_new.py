...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "pyramid_stairs": terrain_gen.PerlinPyramidStairsTerrainCfg(
            ...
            step_width_choices=[0.21, 0.27, 0.30],
            platform_width=2.5,
            border_width=1.0,
            wall_prob=[0.3, 0.3, 0.3, 0.3],
            wall_height=5.0,
...
ROUGH_TERRAINS_CFG_PLAY = TerrainGeneratorCfg(
    seed=0,
    size=(8.0, 8.0),
    border_width=3,
    num_rows=2,
...
class CommandsCfg:
    ...
    base_velocity = mdp.PoseVelocityCommandCfg(
        ...
        velocity_ranges={
            ...
            "pyramid_stairs_high": {"lin_vel_x": (0.4, 0.8), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
...
class CurriculumCfg:
    ...
    terrain_levels = CurrTerm(
        func=mdp.tracking_exp_vel, params={
